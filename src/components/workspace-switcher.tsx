...
export default function WorkspaceSwitcher({
  ...
  return (
    <div className="relative w-full" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute left-0 top-full mt-2 w-56 rounded-sm border border-gray-200 bg-white shadow-lg z-50">
          <div className="p-2">
          ...
          <div className="border-t border-gray-200 p-2 bg-gray-50 rounded-b-sm">
